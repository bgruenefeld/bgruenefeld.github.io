"use strict";
(self["webpackChunkjudgement"] = self["webpackChunkjudgement"] || []).push([["vendors-fcadf5bb"],{
...
/* harmony import */ var aurelia_path__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! aurelia-path */ 8627);
      ...
      if (typeof config === 'string') {
        ...
        switch (resourceType) {
          case 'element':case 'attribute':
            ...
            break;
          case 'valueConverter':
            resource = new aurelia_binding__WEBPACK_IMPORTED_MODULE_5__.ValueConverterResource((0,aurelia_binding__WEBPACK_IMPORTED_MODULE_5__.camelCase)(_name || target.name));
            break;
          case 'bindingBehavior':
            resource = new aurelia_binding__WEBPACK_IMPORTED_MODULE_5__.BindingBehaviorResource((0,aurelia_binding__WEBPACK_IMPORTED_MODULE_5__.camelCase)(_name || target.name));
            break;
...
var ProviderResolver = (0,aurelia_dependency_injection__WEBPACK_IMPORTED_MODULE_6__.resolver)(_class12 = function () {
    ...
    if (target) {
      ...
      if (viewModelRequires) {
        ...
        for (var i = 0, ii = viewModelRequires.length; i < ii; ++i) {
          ...
          var importId = typeof req === 'function' ? aurelia_metadata__WEBPACK_IMPORTED_MODULE_1__.Origin.get(req).moduleId : (0,aurelia_path__WEBPACK_IMPORTED_MODULE_4__.relativeToFile)(req.src || req, registryEntry.address);
...
var BehaviorPropertyObserver = (_dec7 = (0,aurelia_binding__WEBPACK_IMPORTED_MODULE_5__.subscriberCollection)(), _dec7(_class15 = function () {
...
var CompositionEngine = (_dec8 = (0,aurelia_dependency_injection__WEBPACK_IMPORTED_MODULE_6__.inject)(ViewEngine, ViewLocator), _dec8(_class16 = function () {
...
var TemplatingEngine = (_dec9 = (0,aurelia_dependency_injection__WEBPACK_IMPORTED_MODULE_6__.inject)(aurelia_dependency_injection__WEBPACK_IMPORTED_MODULE_6__.Container, ModuleAnalyzer, ViewCompiler, CompositionEngine), _dec9(_class17 = function () {
...
//# sourceMappingURL=vendors-fcadf5bb.09df464c778910d25d44.bundle.js.map